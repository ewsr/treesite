...
class TreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tree" do
    assert_difference('Tree.count') do
      post trees_url, params: { tree: { description: @tree.description, x: @tree.x, y: @tree.y } }
    end
  ...
  test "should update tree" do
    patch tree_url(@tree), params: { tree: { description: @tree.description, x: @tree.x, y: @tree.y } }
